     ...
     ,marginLeft:"10px"}} onClick={handleClickOpen}>
        ...
        , backgroundColor:"#c72120", color:"white",height:"25px"}} >X</Button>
         <form onClick={supprimer}>
           <DialogTitle style={{color:'#6e5244' , marginLeft:"100px", fontFamily:"cursive"
        , fontWeight:"bold", fontSize:"25px"}}>Supprimer un greffier</DialogTitle>
           <p>{msg}</p>
           <DialogContent>
             <TextField 
               autoFocus
   ...
   function Modifgreffier() {
    ...
    const modifier= async (e) => {
     ...
     ,marginLeft:"10px"}} onClick={handleClickOpen}>
           Modifier  </Button>
         <Dialog open={open} onClose={handleClose}>
         <Button onClick={handleClose} style={{ padding: "5px", marginLeft: "510px",width:"3px"
        , backgroundColor:"#c72120", color:"white",height:"25px"}} >X</Button>
         <form onClick={modifier}>
           <DialogTitle style={{color:'#6e5244' , marginLeft:"100px", fontFamily:"cursive"
        , fontWeight:"bold", fontSize:"25px"}} >Modifier un greffier</DialogTitle>
           <p>{msg}</p>
           <DialogContent>
           <TextField 
             autoFocus
  ...
  return (
    <div>
      ...
      >
        ...
        <Button onClick={handleClose} style={{ padding: "5px", marginLeft: "560px",width:"3px"
        , backgroundColor:"#c72120", color:"white",height:"25px"}} >X</Button>
           <DialogTitle style={{color:'#6e5244' , marginLeft:"100px", fontFamily:"cursive"
        , fontWeight:"bold", fontSize:"25px"}} >Liste des Greffiers</DialogTitle>
