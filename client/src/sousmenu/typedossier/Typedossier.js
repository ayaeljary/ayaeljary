...
import Tabtypedossier from './Tabtypedossier';
...
function Adddossier() {
 ...
 const ajouter = async (e) => {
  e.preventDefault();
  try {
      await Axios.post('http://localhost:5000/adtypedossier', {
...
function Suppossier() {
  ...
  const supprimer = async (e) => {
   e.preventDefault();
   try {
       await Axios.post('http://localhost:5000/suptypedossier', {
           id:id,
       });
       setid("");
 ...
 function Modifdossier() {
  ...
  const modifier= async (e) => {
   e.preventDefault();
   try {
       await Axios.post('http://localhost:5000/modiftypedossier', {
           id:id,
           nomdossier:nomdossier,
       });
       setid("");
  ...
  return (
    <div>
      ...
      >
        ...
        , fontWeight:"bold", fontSize:"27px"}} >Liste de type dossier </DialogTitle>
