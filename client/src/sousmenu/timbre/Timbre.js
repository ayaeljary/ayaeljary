    ...
    <div>
     ...
     ,marginLeft:"4px"}} onClick={handleClickOpen}>
      ...
      <form onClick={ajouter}>
        ...
        , fontWeight:"bold", fontSize:"30px"}} >Ajouter un Timbre</DialogTitle>
        <p>{msg}</p>
        <DialogContent>
          <TextField 
            autoFocus
        ...
        <DialogActions>
          <Button style={{color:'white',width:"180px",backgroundColor:"#1f4b77"
   ...
   return (
     ...
     ,marginLeft:"4px"}} onClick={handleClickOpen}>
       ...
       <form onClick={supprimer}>
         <DialogTitle style={{color:'#6e5244' , marginLeft:"100px", fontFamily:"cursive"
        , fontWeight:"bold", fontSize:"30px"}}  >Supprimer un timbre</DialogTitle>
         <p>{msg}</p>
         <DialogContent>
           <TextField 
             autoFocus
         ...
         <DialogActions>
           <Button style={{color:'white',width:"180px",backgroundColor:"#1f4b77"
     ,marginLeft:"4px"}} >Supprimer</Button>
         </DialogActions>
         </form>
       </Dialog>
     ...
     ,marginLeft:"4px"}} onClick={handleClickOpen}>
       ...
       <form onClick={modifier}>
        ...
        , fontWeight:"bold", fontSize:"30px"}}  >Modifier un dossier</DialogTitle>
         ...
         <DialogActions>
           <Button style={{color:'white',width:"180px",backgroundColor:"#1f4b77"
     ,marginLeft:"4px"}} >Modifier</Button>
         </DialogActions>
         </form>
       </Dialog>
  ...
  return (
    <div>
      ...
      >
        ...
        , backgroundColor:"#c72120", color:"white",height:"25px"}} >X</Button>
          <DialogTitle style={{color:'#6e5244' , marginLeft:"100px", fontFamily:"cursive"
        , fontWeight:"bold", fontSize:"30px"}} >Timbre</DialogTitle>
