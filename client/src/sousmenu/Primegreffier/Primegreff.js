  ...
  return (
    <div>
      ...
      >
        ...
        <Button onClick={handleClose} style={{ padding: "5px", marginLeft: "560px",width:"3px", marginTop:"1px"
        , backgroundColor:"#c72120", color:"white",height:"25px"}}>X</Button>
          <DialogTitle style={{color:'#6e5244' , marginLeft:"130px", fontFamily:"cursive"
        , fontWeight:"bold", fontSize:"22px"}} >Liste des primes des greffiers</DialogTitle>
